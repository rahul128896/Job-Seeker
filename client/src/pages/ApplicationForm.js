...
const ApplicationForm = () => {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...prev,
        resumeUrl: `http://localhost:5000${data.fileUrl}`
      }));
          ...
          <div className="job-apply-card">
            ...
            <form className="job-apply-form" onSubmit={handleSubmit}>
              <div className="form-section">
                ...
                <div className="form-group">
                  <label htmlFor="resumeFile" className="form-label">Resume * (Upload File)</label>
                  <div className="file-upload-wrapper">
                    ...
                    <label htmlFor="resumeFile" className="file-upload-label">
                      ...
                      {uploading ? 'Uploading...' : (resumeFile ? resumeFile.name : 'Choose file (PDF, DOC, DOCX)')}
                    </label>
                  </div>
                  {formData.resumeUrl && (
                  ...
                  <small className="form-help-text">Upload your resume (Max 5MB, PDF/DOC/DOCX)</small>
                </div>
                <div className="form-group">
